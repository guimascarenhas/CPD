...
void printTree(node *root, int max_id)
{
    //Os id's dos pontos começam em 0. Por isso o nº de nós é igual ao indice máximo + 1
    int n_nodes = max_id + 1;
